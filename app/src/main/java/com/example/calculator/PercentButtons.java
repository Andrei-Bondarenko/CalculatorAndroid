...
public class PercentButtons {
    ...
    public void buttonPercentHandler(String calculatorNumberHandler) {
        if (operationCount == 0) {
    ...
    public boolean buttonPercentOperationHandler(String calculatorOperation, String checkTextView) {
    ...
    public int buttonPercentPointHandler(String checkTextView) {
        if (checkOpBtn.toCheckOperationButtons(checkTextView)) {
    ...
    public boolean buttonPercentRavnoHandler(String checkTextView) {
        if (checkOpBtn.toCheckOperationButtons(checkTextView)) {
            beforeLastOperation = lastOperation;
            calculator.beforeLastOperation = beforeLastOperation;
            lastOperation = "=";
    ...
    public int buttonDeletePercentHandler(String checkTextView) {
        if (checkTextView.compareTo("") != 0) {
            beforeLastOperation = "";
            calculator.beforeLastOperation = beforeLastOperation;
            lastOperation = "";
            calculator.lastOperation = lastOperation;
            number1 = String.valueOf(calculator.operation);
            number2 = "";
            number3 = "";
            num1 = 0;
            num2 = 0;
